...
:class:`~il2ds_mis_parser.parsers.WeatherParser` is responsible for parsing
...
Gust
  ...
  **Output value**: a value from :data:`~il2ds_mis_parser.constants.GUST_TYPES`
  dictionary
...
Turbulence
  ...
  **Output value**: a value from :data:`~il2ds_mis_parser.constants.TURBULENCE_TYPES`
  dictionary
